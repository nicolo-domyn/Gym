...
For semantic or rubric-based scoring, `verify()` may call a **second language model** (LLM-as-a-judge). For configuration, deployment, and implementation patterns, see [LLM-as-Judge Verification](/environment-tutorials/llm-as-judge-verification).
